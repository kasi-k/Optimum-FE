    ...
    <>
      <div className="relative">
        <div className="font-layout-font absolute -top-13 right-0 flex justify-end items-center gap-2 pb-2">
          <p onClick={() =>setAddEmployee(true)} className="cursor-pointer flex items-center dark:text-white gap-2 bg-select_layout-dark px-4 py-2 text-sm rounded-md">
                ...
                >
                  ...
                  <td className="pl-4 p-2.5 rounded-r-lg space-x-3">
                    ...
                    <button className="cursor-pointer bg-blue-200 w-fit rounded-sm py-1.5 px-1.5">
                     ...
                     <button onClick={ () =>navigate("viewcampaign")} className="cursor-pointer bg-[#BAFFBA] text-green-600 w-fit rounded-sm py-1.5 px-1.5">
                      {" "}
                      <LuEye size={16} />
                    </button>
                  </td>
